...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('heronotification_notification', (
        ...
        db.send_create_signal('heronotification', ['Notification'])


    def backwards(self, orm):
        # Deleting model 'Notification'
        db.delete_table('heronotification_notification')
    ...
    complete_apps = ['heronotification']