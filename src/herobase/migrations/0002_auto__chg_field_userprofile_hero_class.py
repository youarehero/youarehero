...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.hero_class'
        db.alter_column('herobase_userprofile', 'hero_class', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.hero_class'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.hero_class' and its values cannot be restored.")
