...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.public_location'
        db.add_column('herobase_userprofile', 'public_location',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.public_location'
        db.delete_column('herobase_userprofile', 'public_location')
