...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.keep_email_after_gpn'
        db.add_column('herobase_userprofile', 'keep_email_after_gpn',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.keep_email_after_gpn'
        db.delete_column('herobase_userprofile', 'keep_email_after_gpn')
