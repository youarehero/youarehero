...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quest.created'
        db.add_column('herobase_quest', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 11, 0, 0)),
                      keep_default=False)

        # Adding field 'Adventure.created'
        db.add_column('herobase_adventure', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 11, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quest.created'
        db.delete_column('herobase_quest', 'created')

        # Deleting field 'Adventure.created'
        db.delete_column('herobase_adventure', 'created')
