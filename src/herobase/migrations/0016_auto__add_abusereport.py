...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('herobase_abusereport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('reporter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reported report', to=orm['auth.User'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('herobase', ['AbuseReport'])


    def backwards(self, orm):
        # Deleting model 'AbuseReport'
        db.delete_table('herobase_abusereport')
