...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quest.location'
        db.delete_column('herobase_quest', 'location')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Quest.location'
        raise RuntimeError("Cannot reverse this migration. 'Quest.location' and its values cannot be restored.")
