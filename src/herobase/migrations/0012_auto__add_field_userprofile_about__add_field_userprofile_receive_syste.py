...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('herobase_userprofile', 'about',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.receive_system_email'
        db.add_column('herobase_userprofile', 'receive_system_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.receive_private_email'
        db.add_column('herobase_userprofile', 'receive_private_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('herobase_userprofile', 'about')

        # Deleting field 'UserProfile.receive_system_email'
        db.delete_column('herobase_userprofile', 'receive_system_email')

        # Deleting field 'UserProfile.receive_private_email'
        db.delete_column('herobase_userprofile', 'receive_private_email')
