...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('herobase_userprofile', 'sex',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.hero_image'
        db.add_column('herobase_userprofile', 'hero_image',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('herobase_userprofile', 'sex')

        # Deleting field 'UserProfile.hero_image'
        db.delete_column('herobase_userprofile', 'hero_image')
    ...
    models = {
        ...
        'herobase.userprofile': {
            ...
            'hero_image': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
