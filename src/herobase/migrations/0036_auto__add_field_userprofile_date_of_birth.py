...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('herobase_userprofile', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(1938, 4, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.date_of_birth'
        db.delete_column('herobase_userprofile', 'date_of_birth')
    ...
    models = {
        ...
        'herobase.quest': {
            ...
            'done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'done_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'expiration_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
