...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserProfile', fields ['longitude']
        db.create_index('herobase_userprofile', ['longitude'])

        # Adding index on 'UserProfile', fields ['latitude']
        db.create_index('herobase_userprofile', ['latitude'])

        # Adding index on 'Quest', fields ['longitude']
        db.create_index('herobase_quest', ['longitude'])

        # Adding index on 'Quest', fields ['latitude']
        db.create_index('herobase_quest', ['latitude'])


    def backwards(self, orm):
        # Removing index on 'Quest', fields ['latitude']
        db.delete_index('herobase_quest', ['latitude'])

        # Removing index on 'Quest', fields ['longitude']
        db.delete_index('herobase_quest', ['longitude'])

        # Removing index on 'UserProfile', fields ['latitude']
        db.delete_index('herobase_userprofile', ['latitude'])

        # Removing index on 'UserProfile', fields ['longitude']
        db.delete_index('herobase_userprofile', ['longitude'])
