...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quest.level'
        db.delete_column('herobase_quest', 'level')

        # Deleting field 'Quest.experience'
        db.delete_column('herobase_quest', 'experience')

        # Deleting field 'Quest.hero_class'
        db.delete_column('herobase_quest', 'hero_class')

        # Adding field 'Quest.time_effort'
        db.add_column('herobase_quest', 'time_effort',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Quest.experience'
        raise RuntimeError("Cannot reverse this migration. 'Quest.experience' and its values cannot be restored.")
        # Adding field 'Quest.hero_class'
        db.add_column('herobase_quest', 'hero_class',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Quest.time_effort'
        db.delete_column('herobase_quest', 'time_effort')
