...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Adventure.state'
        db.delete_column('herobase_adventure', 'state')

        # Deleting field 'Quest.state'
        db.delete_column('herobase_quest', 'state')


    def backwards(self, orm):
        # Adding field 'Adventure.state'
        db.add_column('herobase_adventure', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)

        # Adding field 'Quest.state'
        db.add_column('herobase_quest', 'state',
