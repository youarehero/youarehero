...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.geolocation'
        db.delete_column('herobase_userprofile', 'geolocation')

        # Adding field 'UserProfile.latitude'
        db.add_column('herobase_userprofile', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'UserProfile.longitude'
        db.add_column('herobase_userprofile', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'UserProfile.location_granularity'
        db.add_column('herobase_userprofile', 'location_granularity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'UserProfile.address'
        db.alter_column('herobase_userprofile', 'address', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'Quest.latitude'
        db.add_column('herobase_quest', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'Quest.longitude'
        db.add_column('herobase_quest', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'Quest.address'
        db.add_column('herobase_quest', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Quest.location_granularity'
        db.add_column('herobase_quest', 'location_granularity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.geolocation'
        db.add_column('herobase_userprofile', 'geolocation',
                      self.gf('django_google_maps.fields.GeoLocationField')(default='49.001925,8.383703', max_length=100),
                      keep_default=False)

        # Deleting field 'UserProfile.latitude'
        db.delete_column('herobase_userprofile', 'latitude')

        # Deleting field 'UserProfile.longitude'
        db.delete_column('herobase_userprofile', 'longitude')

        # Deleting field 'UserProfile.location_granularity'
        db.delete_column('herobase_userprofile', 'location_granularity')


        # Changing field 'UserProfile.address'
        db.alter_column('herobase_userprofile', 'address', self.gf('django_google_maps.fields.AddressField')(max_length=200))
        # Deleting field 'Quest.latitude'
        db.delete_column('herobase_quest', 'latitude')

        # Deleting field 'Quest.longitude'
        db.delete_column('herobase_quest', 'longitude')

        # Deleting field 'Quest.address'
        db.delete_column('herobase_quest', 'address')

        # Deleting field 'Quest.location_granularity'
        db.delete_column('herobase_quest', 'location_granularity')
