...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Quest', fields ['created']
        db.create_index('herobase_quest', ['created'])

        # Adding index on 'Quest', fields ['modified']
        db.create_index('herobase_quest', ['modified'])


    def backwards(self, orm):
        # Removing index on 'Quest', fields ['modified']
        db.delete_index('herobase_quest', ['modified'])

        # Removing index on 'Quest', fields ['created']
        db.delete_index('herobase_quest', ['created'])
