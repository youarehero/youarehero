...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('herobase_userprofile', 'address',
                      self.gf('django_google_maps.fields.AddressField')(default='HfG Karlsruhe, Karlsruhe, Deutschland', max_length=200),
                      keep_default=False)


        # Changing field 'UserProfile.geolocation'
        db.alter_column('herobase_userprofile', 'geolocation', self.gf('django_google_maps.fields.GeoLocationField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'UserProfile.address'
        db.delete_column('herobase_userprofile', 'address')


        # Changing field 'UserProfile.geolocation'
        db.alter_column('herobase_userprofile', 'geolocation', self.gf('herobase.fields.LocationField')(max_length=100))
    ...
    models = {
        ...
        'herobase.userprofile': {
            ...
            'address': ('django_google_maps.fields.AddressField', [], {'default': "'HfG Karlsruhe, Karlsruhe, Deutschland'", 'max_length': '200'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'experience': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'geolocation': ('django_google_maps.fields.GeoLocationField', [], {'default': "'49.001925,8.383703'", 'max_length': '100'}),
            'hero_class': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
