...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.uploaded_image'
        db.add_column(u'herobase_userprofile', 'uploaded_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Quest.start_date'
        db.alter_column(u'herobase_quest', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'UserProfile.uploaded_image'
        db.delete_column(u'herobase_userprofile', 'uploaded_image')


        # Changing field 'Quest.start_date'
        db.alter_column(u'herobase_quest', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'herobase.quest': {
            ...
            'expiration_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 4, 0, 0)'}),
